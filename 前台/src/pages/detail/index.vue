...
export default {
  ...
  methods: {
    ...
    async addOrUpdateCart() {
      ...
      //实质就是调用了小仓库里面相应的这个函数->addOrUpdateCart,声明部分加上asnyc,这个函数执行的结构一定是Promise
      ...
      try {
        ...
        //路由跳转:携带参数,携带参数一般都是基本类型数据【字符串、数字等等】，引用类型数据不行【传递过来路由获取不到】！！！
